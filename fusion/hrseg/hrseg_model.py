...
def create_hrnet():
    ...
    if os.path.basename(os.getcwd()) == 'SDSFusion':
        pretrained_dict = torch.load(os.path.join(os.getcwd(),'pretrain/hrnet_w48_pascal_context_cls59_480x480.pth'))
    elif os.path.basename(os.getcwd()) == 'enhance_stage1':
        path1 = os.path.dirname(os.getcwd())
        pretrained_dict = torch.load(os.path.join(path1,'pretrain/hrnet_w48_pascal_context_cls59_480x480.pth'))
...
if __name__ == '__main__':
    # code for producing semantic maps using hrnet
